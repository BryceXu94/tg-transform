  ...
  >
    ...
    <template #footer>
      <div class="dialog-footer">
        <tg-button @click="handleCancel">取消</tg-button>
        <tg-button
          type="primary"
          @click="handleSubmit"
        >提交</tg-button>
...
import { TgForm, TgMessage } from '@tiangong/components';
...
const formRef = ref<InstanceType<typeof TgForm> | null>(null);
const formData = ref<{
  ownerId: string;
  ownerName: string;
}>({
